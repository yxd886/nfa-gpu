...
coordinator::coordinator(llring_holder& holder){
  ...
  cudaHostAlloc((void**)&pkts[1],MAX_PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(Pkt)*10,cudaHostAllocMapped);
  cudaHostAlloc((void**)&fs[1],MAX_PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(Fs),cudaHostAllocMapped);
  cudaHostAlloc((void**)&flow_size[1],MAX_PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(int),cudaHostAllocMapped);
 // cudaMallocManaged((void**)&d_fs, PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(Fs));
  cudaHostAlloc((void**)&pkts[0],MAX_PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(Pkt)*10,cudaHostAllocMapped);
  cudaHostAlloc((void**)&fs[0],MAX_PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(Fs),cudaHostAllocMapped);
  cudaHostAlloc((void**)&tmp_fs,MAX_PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(Fs),cudaHostAllocMapped);
  //Pkt_reset(pkts,PROCESS_TIME*bess::PacketBatch::kMaxBurst*10);


  cudaHostAlloc((void**)&flow_size[0],MAX_PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(int),cudaHostAllocMapped);
