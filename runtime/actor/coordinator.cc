...
coordinator::coordinator(llring_holder& holder){
  ...
  cudaMalloc((void**)&d_pkts,PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(Pkt)*10);
  cudaMalloc((void**)&d_fs,PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(Fs));
  cudaMalloc((void**)&d_flow_size,PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(int));
 // cudaMallocManaged((void**)&d_fs, PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(Fs));
  cudaHostAlloc((void**)&pkts,PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(Pkt)*10,cudaHostAllocPortable);
  cudaHostAlloc((void**)&fs,PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(Fs),cudaHostAllocPortable);
  cudaHostAlloc((void**)&tmp_fs,PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(Fs),cudaHostAllocPortable);
  //Pkt_reset(pkts,PROCESS_TIME*bess::PacketBatch::kMaxBurst*10);


  cudaHostAlloc((void**)&flow_size,PROCESS_TIME*bess::PacketBatch::kMaxBurst * sizeof(int),cudaHostAllocPortable);
