...
#include "d_network_function_register.h"
...
int d_network_function_register::compute_service_chain_length(uint64_t s){
  int length = 0;
...
uint8_t d_network_function_register::look_up_id(std::string str){
